...
<form action="./register/">
	<label for="user_code">Хабралогин *: </label><input type="text" id="user_code" name="user_code" size="25" <?php if($this->userCode !== '') print 'value="' . htmlspecialchars($this->userCode) . '"'; ?>/> 
