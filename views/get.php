...
<textarea cols="60" rows="6"><a href="<?php print SERVICE_URL; ?>">Хаброметр</a><br /><a href="<?php print SERVICE_URL; ?>users/<?php print $this->userCode; ?>/"><img src="<?php print SERVICE_URL; ?>habrometr_<?php print "{$size['x']}x{$size['y']}"; ?>_<?php print $this->userCode; ?>.png" width="<?php print $size['x']; ?>" height="<?php print $size['y']; ?>" alt="Хаброметр <?php print $this->userCode; ?>" title="Хаброметр <?php print $this->userCode; ?>" /></a></textarea>
<?php } 